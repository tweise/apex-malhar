...
public abstract class AppDataTabularServer implements Operator
{
  ...
  public transient final DefaultInputPort<List<Map<String, Object>>> input = new DefaultInputPort<List<Map<String, Object>>>()
  {
    @Override
    public void process(List<Map<String, Object>> rows)
    {
      ...
      for(Map<String, Object> inputEvent: rows) {
  ...
  public abstract GPOMutable convert(Map<String, Object> inputEvent);
